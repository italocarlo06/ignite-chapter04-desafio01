...
import { TranferStatementController } from '../modules/statements/useCases/transferStatement/TransferStatementController';

const statementRouter = Router();
const getBalanceController = new GetBalanceController();
const createStatementController = new CreateStatementController();
const transferStatmentController = new TranferStatementController();
...
statementRouter.post('/transfer/:destination_user', transferStatmentController.execute);
